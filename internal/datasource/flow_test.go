...
`,
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.appmixer_flow.lookup", "custom_fields.enabled", "true"),
					resource.TestCheckResourceAttr("data.appmixer_flow.lookup", "custom_fields.version", "2"),
				),
			},
		},
	})
